# detail-lowongan-external-apply — canonical iteration selected

**Role:** `public`
**Iterations found in the Stitch export:** 2 (originals: 1, 2)
...
The Google Stitch export contains **2 separate exported iterations** of this screen.
...
```text
archive/stitch-iterations/public/detail-lowongan-external-apply/
├── iteration-1 2 /   (code.html + screen.png)
```
