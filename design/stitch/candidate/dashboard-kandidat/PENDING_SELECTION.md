# dashboard-kandidat — canonical iteration selected

**Role:** `candidate`
**Iterations found in the Stitch export:** 5 (originals: 1, 2, 3, 4, 5)
...
The Google Stitch export contains **5 separate exported iterations** of this screen.
...
```text
archive/stitch-iterations/candidate/dashboard-kandidat/
├── iteration-1 2 3 4 5 /   (code.html + screen.png)
```
