# notifikasi — canonical iteration selected

**Role:** `candidate`
**Iterations found in the Stitch export:** 3 (originals: 1, 2, 4)
...
```text
archive/stitch-iterations/candidate/notifikasi/
├── iteration-1 2 4 /   (code.html + screen.png)
```
