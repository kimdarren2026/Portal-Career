...
function applyFilter() {
    ...
    router.get('/kepegawaian/notifikasi', query, { preserveState: true, replace: true })
}
...
<template>
    ...
    <AppShell persona="admin-kepegawaian" active="kepegawaian/notifikasi" title="Notifikasi">
