...
<template>
    <div class="min-h-screen bg-[#f7fafc] text-[#181c1e]">
        <header class="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 md:hidden"><a href="/candidate/profile/edit" class="font-bold text-[#002045]">Portal Karir Kampus</a><span class="text-sm font-medium text-slate-600">Profil Saya</span></header>
        <aside class="fixed inset-y-0 hidden w-72 flex-col bg-[#1B2D4F] p-6 text-white md:flex">
            <a href="/candidate/profile/edit" class="text-xl font-bold">Portal Karir Kampus</a><p class="mt-1 text-sm text-blue-100">Portal Karir Terpadu</p>
            <nav class="mt-10 space-y-2" aria-label="Navigasi kandidat">
                <a href="/candidate/profile/edit" class="flex rounded-lg bg-[#66affe] px-4 py-3 font-semibold text-[#004172]">Profil Saya</a>
                <a href="#documents" class="flex rounded-lg px-4 py-3 text-white/80 hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Dokumen pribadi</a>
            </nav>
            <p class="mt-auto text-xs leading-5 text-white/65">Menu kandidat lain akan mengikuti audit konsistensi navigasi yang terpisah.</p>
        </aside>
